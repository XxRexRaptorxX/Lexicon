...
This farm doesn't focus on any specific [monsters](../creatures/monsters.md). It let them spawn which then pushed from the *Water* 
into a pit where they are killed by a <ItemLink id="minecraft:magma_block" />. 
The drops are then transported into a [<ItemLink id="minecraft:chest" />](../useables/chest.md) by a <ItemLink id="minecraft:hopper_minecart" />. 
