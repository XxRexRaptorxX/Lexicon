...
- Use a <ItemLink id="minecraft:compass" />, it always points to the *Spawnpoint* of your world, you should always be able to find your base from there. 
- Alternatively, you can use the *F3* key to display your coordinates in the world. 
- You can also mark your way with a <ItemLink id="minecraft:torch" /> or tower! 
