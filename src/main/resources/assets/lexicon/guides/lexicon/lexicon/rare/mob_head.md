...
*Player Heads* have an extra usage for mapmakers, they can be given [*NBT Data*](../commands/nbt-data.md) so that they appear with the skin of any Minecraft account. But they cannot be reached in survival by default. 

To get this heads, use this [*Command*](../commands.md): __/give @p minecraft:player_head{SkullOwner:*ACCOUNT_NAME*}__
