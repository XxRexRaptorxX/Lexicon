...
In the client, commands are entered via [<ItemLink id="minecraft:command_block" />](./redstone/redstone_components.md#command_block) or chat window, which is displayed by pressing the **T** or **/ key**. 
