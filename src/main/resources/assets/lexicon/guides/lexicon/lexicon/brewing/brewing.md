...
Base potions are [*Potions*](brewing.md#potions) without effects, brewed by adding a single base ingredient to a *Water Bottle*. Of these, only the *Awkward Potion* can be imbued with an effect ingredient to produce a 
[*Potion Effect*](./effects.md).
...
[*Potions*](brewing.md#potions) are bottled substances which give [*Players*](../creatures/human-player.md) and mobs a limited-time or instant status effect if drunk or within its splash radius when thrown (in the 
case of 
[*Lingering*](./potion_types.md) and [*Splash Potions*](./potion_types.md)).
...
Upgrading a [*Potion*](brewing.md#potions) involves a trade-off between duration & potency. 
An enhanced effect has shorter duration, & extended duration cannot have an enhanced effect.
