...
A <ItemLink id="minecraft:conduit" />  is a <ItemLink id="minecraft:beacon" />-like block that provides [*Conduit Power*](../brewing/effects.md#conduit_power) and attacks hostile [*mobs*](../creatures.md) underwater. 
...
To activate, a <ItemLink id="minecraft:conduit" />  needs to be in the center of a 3×3×3 volume of *Water*, which itself must be enclosed within an activation frame. 

Only <ItemLink id="minecraft:prismarine" />, <ItemLink id="minecraft:dark_prismarine" />, <ItemLink id="minecraft:prismarine_bricks" />, and <ItemLink id="minecraft:sea_lantern" /> 
-blocks in the frame contribute to activation.
