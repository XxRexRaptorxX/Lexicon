...
__Spawn:__ [Nether](../world/dimensions.md#nether), when a [Piglin](./monster-piglin.md) leaves the [Nether](../world/dimensions.md#nether), when a [*Pig*](./animal-pig.md) is struck with a lightning bolt       
__Properties:__     
...
> __Drops:__ 0-1 Rotten Flesh, 0-1 Gold Nugget, 2.5% chance for a Gold Ingot, 8.5% chance for the held [Weapon](../combat/weapons.md)   
> __XP:__ adult 5, baby 12
